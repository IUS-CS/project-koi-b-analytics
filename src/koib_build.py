...
#button functions are in order as they appear in GUI
    ...
    def srch_btn(self):#UPDATES PRELIMINARY STATS SO USER CAN DECIDE IF THEY WANT TO ADD THIS PLAYER
        ...
        self.ids.stat_name.text = "NAME: " + player_name
        self.ids.stat_team.text = "TEAM: " + team_name
        self.ids.stat_pos.text = "POSITION: " + pos_name
        self.ids.stat_pts.text = "PPG: " + pts_name
        self.ids.stat_fg.text = "FG %: " + fg_name
